          ...
          <form id="regForm" noValidate onSubmit={handleSubmit}>
            ...
            <div className="field">
              <div className="input-wrap">
                ...
                <input type={showConfirmPassword ? "text" : "password"} id="confirmPassword" placeholder=" " autoComplete="new-password" value={formData.confirmPassword} onChange={handleChange} required />
                ...
                <span className="field-right-ic">
                  ...
                  <span className="toggle-pass" id="togglePass2" tabIndex="0" role="button" aria-label="Show password" onClick={() => setShowConfirmPassword(!showConfirmPassword)}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8Z"/><circle cx="12" cy="12" r="3"/></svg>
                  </span>
                </span>
              </div>
            ...
            <div className="field">
              <div className="input-wrap">
                ...
                <select id="education" className={formData.education ? 'has-val' : ''} value={formData.education} onChange={handleChange} required>
            ...
            <div className="field">
              <div className="input-wrap">
                ...
                <select id="academicYear" className={formData.academicYear ? 'has-val' : ''} value={formData.academicYear} onChange={handleChange} required>
                  <option value="" disabled></option>
              ...
              <div className="err-msg" id="err-academicYear"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg><span>Please select academic year</span></div>
            </div>
